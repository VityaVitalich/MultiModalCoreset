...
def _gen_fbnetv3(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    ...
    if vl in ("a", "b"):
        ...
        arch_def = [
            ...
            [
                "ir_r1_k3_s2_e6_c184_se0.25",
                "ir_r5_k5_s1_e4_c184_se0.25",
                "ir_r1_k5_s1_e6_c224_se0.25",
            ],
            ["cn_r1_k1_s1_c1344"],
        ]
    elif vl == "d":
        ...
        arch_def = [
            ...
            [
                "ir_r1_k3_s2_e6_c208_se0.25",
                "ir_r5_k5_s1_e5_c208_se0.25",
                "ir_r1_k5_s1_e6_c240_se0.25",
            ],
            ["cn_r1_k1_s1_c1440"],
        ]
    elif vl == "g":
        ...
        arch_def = [
            ...
            [
                "ir_r1_k3_s2_e6_c264_se0.25",
                "ir_r6_k5_s1_e5_c264_se0.25",
                "ir_r2_k5_s1_e6_c288_se0.25",
            ],
            ["cn_r1_k1_s1_c1728"],
        ]
    else:
    ...
    round_chs_fn = partial(
        round_channels, multiplier=channel_multiplier, round_limit=0.95
    )
    se_layer = partial(
        SqueezeExcite, gate_layer="hard_sigmoid", rd_round_fn=round_chs_fn
    )
    act_layer = resolve_act_layer(kwargs, "hard_swish")
    model_kwargs = dict(
        block_args=decode_arch_def(arch_def),
...
def _gen_lcnet(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    ...
    model_kwargs = dict(
        ...
        act_layer=resolve_act_layer(kwargs, "hard_swish"),
        se_layer=partial(
            SqueezeExcite, gate_layer="hard_sigmoid", force_act_layer=nn.ReLU
        ),
        num_features=1280,
        **kwargs,
    )
...
def mobilenetv3_large_100_miil(pretrained=False, **kwargs):
    ...
    """
    model = _gen_mobilenet_v3(
        "mobilenetv3_large_100_miil", 1.0, pretrained=pretrained, **kwargs
    )
    return model
...
def mobilenetv3_large_100_miil_in21k(pretrained=False, **kwargs):
    ...
    """
    model = _gen_mobilenet_v3(
        "mobilenetv3_large_100_miil_in21k", 1.0, pretrained=pretrained, **kwargs
    )
    return model
