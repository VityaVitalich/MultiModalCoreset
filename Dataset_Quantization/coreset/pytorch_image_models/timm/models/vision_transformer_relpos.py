...
def vit_relpos_base_patch16_plus_240(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer_relpos(
        "vit_relpos_base_patch16_plus_240", pretrained=pretrained, **model_kwargs
    )
    return model
...
def vit_relpos_small_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer_relpos(
        "vit_relpos_small_patch16_224", pretrained=pretrained, **model_kwargs
    )
    return model
...
def vit_relpos_medium_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer_relpos(
        "vit_relpos_medium_patch16_224", pretrained=pretrained, **model_kwargs
    )
    return model
...
def vit_relpos_base_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer_relpos(
        "vit_relpos_base_patch16_224", pretrained=pretrained, **model_kwargs
    )
    return model
...
def vit_srelpos_small_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer_relpos(
        "vit_srelpos_small_patch16_224", pretrained=pretrained, **model_kwargs
    )
    return model
...
def vit_relpos_base_patch16_cls_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer_relpos(
        "vit_relpos_base_patch16_cls_224", pretrained=pretrained, **model_kwargs
    )
    return model
