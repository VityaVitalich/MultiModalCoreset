...
default_cfgs = {
    "hardcorenas_a": _cfg(
        url="https://miil-public-eu.oss-eu-central-1.aliyuncs.com/public/HardCoReNAS/HardCoreNAS_A_Green_38ms_75.9_23474aeb.pth"
    ),
    "hardcorenas_b": _cfg(
        url="https://miil-public-eu.oss-eu-central-1.aliyuncs.com/public/HardCoReNAS/HardCoreNAS_B_Green_40ms_76.5_1f882d1e.pth"
    ),
    "hardcorenas_c": _cfg(
        url="https://miil-public-eu.oss-eu-central-1.aliyuncs.com/public/HardCoReNAS/HardCoreNAS_C_Green_44ms_77.1_d4148c9e.pth"
    ),
    "hardcorenas_d": _cfg(
        url="https://miil-public-eu.oss-eu-central-1.aliyuncs.com/public/HardCoReNAS/HardCoreNAS_D_Green_50ms_77.4_23e3cdde.pth"
    ),
    "hardcorenas_e": _cfg(
        url="https://miil-public-eu.oss-eu-central-1.aliyuncs.com/public/HardCoReNAS/HardCoreNAS_E_Green_55ms_77.9_90f20e8a.pth"
    ),
    "hardcorenas_f": _cfg(
        url="https://miil-public-eu.oss-eu-central-1.aliyuncs.com/public/HardCoReNAS/HardCoreNAS_F_Green_60ms_78.1_2855edf1.pth"
    ),
}
...
def hardcorenas_a(pretrained=False, **kwargs):
    ...
    model = _gen_hardcorenas(
        pretrained=pretrained, variant="hardcorenas_a", arch_def=arch_def, **kwargs
    )
    return model
...
def hardcorenas_b(pretrained=False, **kwargs):
    ...
    arch_def = [
        ["ds_r1_k3_s1_e1_c16_nre"],
        [
            "ir_r1_k5_s2_e3_c24_nre",
            "ir_r1_k5_s1_e3_c24_nre_se0.25",
            "ir_r1_k3_s1_e3_c24_nre",
        ],
        ...
        [
            ...
            "ir_r1_k3_s1_e3_c192_se0.25",
        ],
        ["cn_r1_k1_s1_c960"],
    ]
    model = _gen_hardcorenas(
        pretrained=pretrained, variant="hardcorenas_b", arch_def=arch_def, **kwargs
    )
    return model
...
def hardcorenas_c(pretrained=False, **kwargs):
    ...
    model = _gen_hardcorenas(
        pretrained=pretrained, variant="hardcorenas_c", arch_def=arch_def, **kwargs
    )
    return model
...
def hardcorenas_d(pretrained=False, **kwargs):
    ...
    model = _gen_hardcorenas(
        pretrained=pretrained, variant="hardcorenas_d", arch_def=arch_def, **kwargs
    )
    return model
...
def hardcorenas_e(pretrained=False, **kwargs):
    ...
    model = _gen_hardcorenas(
        pretrained=pretrained, variant="hardcorenas_e", arch_def=arch_def, **kwargs
    )
    return model
...
def hardcorenas_f(pretrained=False, **kwargs):
    ...
    model = _gen_hardcorenas(
        pretrained=pretrained, variant="hardcorenas_f", arch_def=arch_def, **kwargs
    )
    return model
