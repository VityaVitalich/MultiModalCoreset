...
class CellStem0(CellBase):
    def __init__(
        ...
        self.conv_1x1 = ActConvBn(
            in_chs_right, out_chs_right, kernel_size=1, padding=pad_type
        )
            ...
            OrderedDict(
                [
                    ...
                    (
                        "conv",
                        create_conv2d(
                            in_chs_left, out_chs_left, kernel_size=1, padding=pad_type
                        ),
                    ),
    ...
    def __init__(
        ...
        if match_prev_layer_dims:
            self.conv_prev_1x1 = FactorizedReduction(
                in_chs_left, out_chs_left, padding=pad_type
            )
        else:
        ...
        self.comb_iter_0_right = create_pool2d(
            "max", 3, stride=stride, padding=pad_type
        )

        self.comb_iter_1_left = BranchSeparables(
            out_chs_right, out_chs_right, kernel_size=7, stride=stride, padding=pad_type
        )
        self.comb_iter_1_right = create_pool2d(
            "max", 3, stride=stride, padding=pad_type
        )
        ...
        self.comb_iter_3_left = BranchSeparables(
            out_chs_right, out_chs_right, kernel_size=3
        )
