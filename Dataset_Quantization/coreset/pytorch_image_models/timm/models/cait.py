...
def _create_cait(variant, pretrained=False, **kwargs):
    ...
    model = build_model_with_cfg(
        Cait, variant, pretrained, pretrained_filter_fn=checkpoint_filter_fn, **kwargs
    )
    return model
...
def cait_xxs24_224(pretrained=False, **kwargs):
    model_args = dict(
        patch_size=16, embed_dim=192, depth=24, num_heads=4, init_values=1e-5, **kwargs
    )
...
def cait_xxs36_224(pretrained=False, **kwargs):
    model_args = dict(
        patch_size=16, embed_dim=192, depth=36, num_heads=4, init_values=1e-5, **kwargs
    )
...
def cait_xs24_384(pretrained=False, **kwargs):
    model_args = dict(
        patch_size=16, embed_dim=288, depth=24, num_heads=6, init_values=1e-5, **kwargs
    )
...
def cait_s24_224(pretrained=False, **kwargs):
    model_args = dict(
        patch_size=16, embed_dim=384, depth=24, num_heads=8, init_values=1e-5, **kwargs
    )
...
def cait_s36_384(pretrained=False, **kwargs):
    model_args = dict(
        patch_size=16, embed_dim=384, depth=36, num_heads=8, init_values=1e-6, **kwargs
    )
...
def cait_m36_384(pretrained=False, **kwargs):
    model_args = dict(
        patch_size=16, embed_dim=768, depth=36, num_heads=16, init_values=1e-6, **kwargs
    )
...
def cait_m48_448(pretrained=False, **kwargs):
    model_args = dict(
        patch_size=16, embed_dim=768, depth=48, num_heads=16, init_values=1e-6, **kwargs
    )
