...
default_cfgs = {
    ...
    "botnet50ts_256": _cfg(
        url="", fixed_input_size=True, input_size=(3, 256, 256), pool_size=(8, 8)
    ),
...
model_cfgs = dict(
    ...
    sebotnet33ts=ByoModelCfg(
        blocks=(
            ByoBlockCfg(type="bottle", d=2, c=256, s=1, gs=0, br=0.25),
            interleave_blocks(
                types=("bottle", "self_attn"), every=[2], d=3, c=512, s=2, gs=0, br=0.25
            ),
            interleave_blocks(
    ...
    haloregnetz_b=ByoModelCfg(
        blocks=(
            ...
            interleave_blocks(
                types=("bottle", "self_attn"), every=3, d=12, c=192, s=2, gs=16, br=3
            ),
...
def botnet26t_256(pretrained=False, **kwargs):
    ...
    return _create_byoanet(
        "botnet26t_256", "botnet26t", pretrained=pretrained, **kwargs
    )
...
def sebotnet33ts_256(pretrained=False, **kwargs):
    ...
    return _create_byoanet(
        "sebotnet33ts_256", "sebotnet33ts", pretrained=pretrained, **kwargs
    )
...
def botnet50ts_256(pretrained=False, **kwargs):
    ...
    kwargs.setdefault("img_size", 256)
    return _create_byoanet(
        "botnet50ts_256", "botnet50ts", pretrained=pretrained, **kwargs
    )
...
def eca_botnext26ts_256(pretrained=False, **kwargs):
    ...
    kwargs.setdefault("img_size", 256)
    return _create_byoanet(
        "eca_botnext26ts_256", "eca_botnext26ts", pretrained=pretrained, **kwargs
    )
...
def lamhalobotnet50ts_256(pretrained=False, **kwargs):
    ...
    return _create_byoanet(
        "lamhalobotnet50ts_256", "lamhalobotnet50ts", pretrained=pretrained, **kwargs
    )
...
def halo2botnet50ts_256(pretrained=False, **kwargs):
    ...
    return _create_byoanet(
        "halo2botnet50ts_256", "halo2botnet50ts", pretrained=pretrained, **kwargs
    )
