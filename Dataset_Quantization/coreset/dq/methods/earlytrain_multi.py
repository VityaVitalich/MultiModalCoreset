...
class EarlyTrainMulti(CoresetMethod):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        # dst pretrain dict is never provided in main script in repo
        ...
        self.if_dst_pretrain = False#len(self.dst_pretrain_dict) != 0
    ...
    def run(self):
        ...
        #     self.args.device
        # )
        # Move init model to the init, cuz we do not need to train it every time from scratch
