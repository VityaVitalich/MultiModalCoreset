...
class Submodular(EarlyTrain):
        ...
        if batch_idx % self.args.print_freq == 0:
            print(
                ...
                % (
                    ...
                    self.epochs,
                    batch_idx,
                    (self.n_pretrain_size // batch_size),
                    loss.item(),
                )
            )
    ...
    def calc_gradient(self, index=None):
        ...
        for i, (input, targets) in enumerate(batch_loader):
            ...
            loss = self.criterion(
                torch.nn.functional.softmax(outputs.requires_grad_(True), dim=1),
        ...
        with self.model.embedding_recorder:
            ...
            if self.balance:
                ...
                for c in range(self.num_classes):
                    ...
                    c_indx = self.train_indx[
                        self.dst_train.dataset.targets[subset_indices] == c
                    ]
